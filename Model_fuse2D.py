#this is a feature fusion of deepLandU and deepLandS
...
model1 = Sequential()
model1.add(Conv2D(64,(3,3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal', input_shape = x_train.shape[1:], data_format= 'channels_first'))
model1.add(Conv2D(64, (3,3), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model1.add(Dropout(0.10))
model1.add(AveragePooling2D(pool_size=(2, 2), strides = 2, data_format= 'channels_first'))

model1.add(Conv2D(128, (3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model1.add(LeakyReLU(alpha=1e-1))
model1.add(Conv2D(128, (3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model1.add(LeakyReLU(alpha=1e-1))
model1.add(Dropout(0.10))
model1.add(MaxPooling2D(pool_size=(2, 2), strides = 2, data_format= 'channels_first'))

model1.add(Conv2D(256, (3, 3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model1.add(LeakyReLU(alpha=1e-1))
model1.add(Conv2D(256,(3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model1.add(LeakyReLU(alpha=1e-1))
model1.add(Conv2D(256,(3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
...
model1.add(Conv2D(512, (3, 3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model1.add(LeakyReLU(alpha=1e-1))
model1.add(Conv2D(512,(3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model1.add(LeakyReLU(alpha=1e-1))
model1.add(Conv2D(512,(3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
...
model1.add(LeakyReLU(alpha=1e-1))
model1.add(Dropout(0.10))
model1.add(UpSampling2D(size=(2,2), data_format= 'channels_first'))
...
model1.add(Conv2D(64, (3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model1.add(LeakyReLU(alpha=1e-1))
model1.add(Conv2D(1,(3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model1.add(LeakyReLU(alpha=1e-1))
model1.add(Dropout(0.10))
...
np.save("y_predictdeepLandF",y_predict)
np.save("y_classdeepLandF",y_class)

#load cnnmodel and do predict and class once again

w = deepLandF.get_weights()
np.save('weightsdeepLandF', w)

histdict = cnn.history

import csv 

w = csv.writer(open("deepLandF.csv", "w"))
