...
model2.add(AveragePooling2D(pool_size=(2, 2), strides = 2, data_format= 'channels_first'))

model2.add(Conv2D(128, (3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model2.add(LeakyReLU(alpha=1e-1))
model2.add(Conv2D(128, (3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model2.add(LeakyReLU(alpha=1e-1))
model2.add(Dropout(0.10))
model2.add(MaxPooling2D(pool_size=(2, 2), strides = 2, data_format= 'channels_first'))

model2.add(Conv2D(256, (3, 3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model2.add(LeakyReLU(alpha=1e-1))
model2.add(Conv2D(256,(3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model2.add(LeakyReLU(alpha=1e-1))
model2.add(Conv2D(256,(3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
...
model2.add(Conv2D(512, (3, 3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model2.add(LeakyReLU(alpha=1e-1))
model2.add(Conv2D(512,(3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model2.add(LeakyReLU(alpha=1e-1))
model2.add(Conv2D(512,(3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
...
model2.add(Conv2D(64, (3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model2.add(LeakyReLU(alpha=1e-1))
model2.add(Conv2D(1,(3,3), padding = 'same', kernel_initializer = 'he_normal', data_format= 'channels_first'))
model2.add(LeakyReLU(alpha=1e-1))
model2.add(Dropout(0.10))
...
deepLandF.compile(optimizer=Adam(lr = 1e-4),
...
np.save("y_predictdeepLandF3",y_predict)
np.save("y_classdeepLandF3",y_class)

#load cnnmodel and do predict and class once again

w = deepLandF.get_weights()
np.save('weightsdeepLandF3', w)

histdict = cnn.history

import csv 

with open("deepLandF3.csv", "w", newline = '') as file:
    w = csv.writer(file)
